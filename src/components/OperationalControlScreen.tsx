...
const OperationalControlScreen = () => {
  ...
  const handleSendBroadcast = () => {
    ...
    alert(`Message: "${broadcastMsg}" has been sent to all active users and partners.`);
    setBroadcastMsg('');
  };
        ...
        <View style={styles.contentWrapper}>
          <View style={styles.content}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.card}>
                {zones.map((zone, idx) => (
                  <View key={`${zone.id}-${idx}`} style={[styles.zoneItem, idx === zones.length - 1 && { borderBottomWidth: 0 }]}>

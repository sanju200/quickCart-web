...
const LiveDeliveryMap = () => {
  ...
  return (
    <View style={styles.rootContainer}>
      ...
      >
        <Animated.View style={{ opacity: fadeAnim, width: '100%', maxWidth: 800 }}>
          ...
          <View style={[styles.mapContainer, { height: MAP_HEIGHT }]}>
            <View style={styles.gridBackground}>
              <View style={[styles.street, { top: MAP_HEIGHT * 0.30, left: 0, width: contentWidth, height: 18 }]} />
              <View style={[styles.street, { top: MAP_HEIGHT * 0.65, left: 0, width: contentWidth, height: 18 }]} />
              <View style={[styles.street, { top: 0, left: contentWidth * 0.25, width: 18, height: MAP_HEIGHT }]} />
              <View style={[styles.street, { top: 0, left: contentWidth * 0.70, width: 18, height: MAP_HEIGHT }]} />
              ...
              <View style={[styles.hubMarker, { top: MAP_HEIGHT * 0.42, left: contentWidth * 0.42 }]}>
              ...
              {PARTNERS.map(partner => (
                <View
                  key={partner.id}
                  style={[styles.partnerMarker, { top: partner.top * (MAP_HEIGHT / 430), left: partner.left * (contentWidth / 390) }]}
                >
...
const styles = StyleSheet.create({
  ...
  statCard: {
    ...
    borderTopWidth: 3,
    elevation: 2,
    bottomBoxShadow: { width: 0, height: 1, color: '#000', opacity: 0.06, radius: 3 },
  },
  statNumber: {
    fontSize: 22,
    fontWeight: '800',
